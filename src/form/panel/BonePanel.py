...
BONE_PAIRS = {
    "全ての親": {"name": "全ての親", "parent": None, "tail": "センター", "display": "全ての親"},
    "センター": {"name": "センター", "parent": "全ての親", "tail": -1, "display": "センター"},
    "グルーブ": {"name": "グルーブ", "parent": "センター", "tail": -1, "display": "センター"},
    ...
    "左肩P": {"name": "左肩P", "parent": "上半身2", "tail": -1, "display": "左手"},
    "leftShoulder": {"name": "左肩", "parent": "左肩P", "tail": "左腕", "display": "左手"},
    "左肩C": {"name": "左肩C", "parent": "左肩", "tail": -1, "display": None},
    "leftUpperArm": {"name": "左腕", "parent": "左肩C", "tail": "左ひじ", "display": "左手"},
    "左腕捩": {"name": "左腕捩", "parent": "左腕", "tail": -1, "display": "左手"},
    "左腕捩1": {"name": "左腕捩1", "parent": "左腕", "tail": -1, "display": None},
    "左腕捩2": {"name": "左腕捩2", "parent": "左腕", "tail": -1, "display": None},
    "左腕捩3": {"name": "左腕捩3", "parent": "左腕", "tail": -1, "display": None},
    "leftLowerArm": {"name": "左ひじ", "parent": "左腕捩", "tail": "左手首", "display": "左手"},
    "左手捩": {"name": "左手捩", "parent": "左ひじ", "tail": -1, "display": "左手"},
    "左手捩1": {"name": "左手捩1", "parent": "左ひじ", "tail": -1, "display": None},
    "左手捩2": {"name": "左手捩2", "parent": "左ひじ", "tail": -1, "display": None},
    "左手捩3": {"name": "左手捩3", "parent": "左ひじ", "tail": -1, "display": None},
    ...
    "右肩P": {"name": "右肩P", "parent": "上半身2", "tail": -1, "display": "右手"},
    "rightShoulder": {"name": "右肩", "parent": "右肩P", "tail": "右腕", "display": "右手"},
    "右肩C": {"name": "右肩C", "parent": "右肩", "tail": -1, "display": None},
    "rightUpperArm": {"name": "右腕", "parent": "右肩C", "tail": "右ひじ", "display": "右手"},
    "右腕捩": {"name": "右腕捩", "parent": "右腕", "tail": -1, "display": "右手"},
    "右腕捩1": {"name": "右腕捩1", "parent": "右腕", "tail": -1, "display": None},
    "右腕捩2": {"name": "右腕捩2", "parent": "右腕", "tail": -1, "display": None},
    "右腕捩3": {"name": "右腕捩3", "parent": "右腕", "tail": -1, "display": None},
    "rightLowerArm": {"name": "右ひじ", "parent": "右腕捩", "tail": "右手首", "display": "右手"},
    "右手捩": {"name": "右手捩", "parent": "右ひじ", "tail": -1, "display": "右手"},
    "右手捩1": {"name": "右手捩1", "parent": "右ひじ", "tail": -1, "display": None},
    "右手捩2": {"name": "右手捩2", "parent": "右ひじ", "tail": -1, "display": None},
    "右手捩3": {"name": "右手捩3", "parent": "右ひじ", "tail": -1, "display": None},
    ...
    "左足ＩＫ": {"name": "左足ＩＫ", "parent": "全ての親", "tail": -1, "display": "左足"},
    "左つま先ＩＫ": {"name": "左つま先ＩＫ", "parent": "左足ＩＫ", "tail": -1, "display": "左足"},
    "腰キャンセル右": {"name": "腰キャンセル右", "parent": "下半身", "tail": -1, "display": None},
    ...
    "右足ＩＫ": {"name": "右足ＩＫ", "parent": "全ての親", "tail": -1, "display": "右足"},
    "右つま先ＩＫ": {"name": "右つま先ＩＫ", "parent": "右足ＩＫ", "tail": -1, "display": "右足"},
    "左足D": {"name": "左足D", "parent": "腰キャンセル左", "tail": -1, "display": "左足"},
    "左ひざD": {"name": "左ひざD", "parent": "左足D", "tail": -1, "display": "左足"},
    "左足首D": {"name": "左足首D", "parent": "左ひざD", "tail": -1, "display": "左足"},
    "左足先EX": {"name": "左足先EX", "parent": "左足首D", "tail": -1, "display": "左足"},
    "右足D": {"name": "右足D", "parent": "腰キャンセル右", "tail": -1, "display": "右足"},
    "右ひざD": {"name": "右ひざD", "parent": "右足D", "tail": -1, "display": "右足"},
    "右足首D": {"name": "右足首D", "parent": "右ひざD", "tail": -1, "display": "右足"},
    "右足先EX": {"name": "右足先EX", "parent": "右足首D", "tail": -1, "display": "右足"},
}
