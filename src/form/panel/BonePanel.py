...
BONE_PAIRS = {
    ...
    "J_Sec_L_Bust1": {"name": "左胸", "parent": "上半身2", "tail": -1, "display": "胸", "rigidBody": 0, "rigidbodyMode": 0, "rigidbodyFactor": 1, "rigidbodyCollisions": 0, "rigidbodyNoCollisions": [0, 1, 2], "rigidbodyParam": [1, 0.5, 0.5, 0, 0.5]},
    ...
    "J_Sec_R_Bust1": {"name": "右胸", "parent": "上半身2", "tail": -1, "display": "胸", "rigidBody": 0, "rigidbodyMode": 0, "rigidbodyFactor": 1, "rigidbodyCollisions": 0, "rigidbodyNoCollisions": [0, 1, 2], "rigidbodyParam": [1, 0.5, 0.5, 0, 0.5]},
...
RIGIDBODY_PAIRS = {
    "髪": {"rigidbodySubdivision": 1, "rigidBody": 2, "rigidbodyFactor": 1, "rigidbodyCoefficient": 2, "rigidbodyCollisions": 3, "rigidbodyNoCollisions": [1, 2, 3, 9], "rigidbodyParamFrom": [1, 0.7, 0.7, 0, 0], "rigidbodyParamTo": [0.1, 0.999, 0.999, 0, 0], "JointTLMin": [0, 0, 0], "JointTLMax": [0, 0, 0], "JointRLMin": [-80, -5, -80], "JointRLMax": [80, 5, 10], "JointSCT": [1, 1, 1], "JointSCR": [10, 10, 10]},
    "Sleeve": {"rigidbodySubdivision": 1, "rigidBody": 2, "rigidbodyFactor": 1, "rigidbodyCoefficient": 2, "rigidbodyCollisions": 4, "rigidbodyNoCollisions": [0, 1, 2, 3, 4, 9], "rigidbodyParamFrom": [2, 0.9, 0.9, 0, 0.5], "rigidbodyParamTo": [0.5, 0.9999, 0.9999, 0, 0.5], "JointTLMin": [0, 0, 0], "JointTLMax": [0, 0, 0], "JointRLMin": [-15, -2, -25], "JointRLMax": [135, 2, 25], "JointSCT": [10, 10, 10], "JointSCR": [50, 50, 50]},
    "Skirt": {"rigidbodySubdivision": 1, "rigidBody": 1, "rigidbodyFactor": 1, "rigidbodyCoefficient": 2, "rigidbodyCollisions": 4, "rigidbodyNoCollisions": [0, 1, 4, 9], "rigidbodyParamFrom": [2, 0.9, 0.9, 0, 0.5], "rigidbodyParamTo": [0.5, 0.9999, 0.9999, 0, 0.5], "JointTLMin": [0, 0, 0], "JointTLMax": [0, 0, 0], "JointRLMin": [-15, -2, -25], "JointRLMax": [135, 2, 25], "JointSCT": [10, 10, 10], "JointSCR": [50, 50, 50]},
    "Others": {"rigidbodySubdivision": 1, "rigidBody": 2, "rigidbodyFactor": 1, "rigidbodyCoefficient": 2, "rigidbodyCollisions": 9, "rigidbodyNoCollisions": [], "rigidbodyParamFrom": [2, 0.9, 0.9, 0, 0.5], "rigidbodyParamTo": [0.5, 0.9999, 0.9999, 0, 0.5], "JointTLMin": [0, 0, 0], "JointTLMax": [0, 0, 0], "JointRLMin": [-15, -2, -25], "JointRLMax": [135, 2, 25], "JointSCT": [10, 10, 10], "JointSCR": [50, 50, 50]},
